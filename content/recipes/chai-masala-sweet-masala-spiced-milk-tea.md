...
- More spices if you want to experiment, any of (pick 2-3 for best results):
    ...
    - 2-4 allspice pod
    - some cinnamon bark
    - 1 cm knob/slice of ginger  
        (sliced, crushed, or whatever, no need to peel if it’s clean)
    - 2-3 peppercorns
...
3. Simmer water, tea, sugar, and lightly smashed spices hard for ~5-7 minutes.  
    Tea should end up with a reddish hue (if not, apply heat longer).
4. Add milk or cream, and return to a simmer for ~2 minutes. Allow chai to bubble up to the top of the pot, removing from heat briefly to prevent boil-over. Repeat this 2-3x to froth the milk, then simmer for the remaining time.
5. Rest/cool for 5 minutes. Pour through a fine mesh sieve.
