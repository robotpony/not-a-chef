...
I like to cook sausage-like things in a sheet pan or thin steam pan, sort of like a thin meatloaf, then I cut it up to freeze. To prepare the meat for gyros or other uses, defrost, slice thinly, and reheat in a pan (to get that classic style crust). Prepping it in this way allows you to cook a bunch for future use, and to make it easy to get consistent shapes for all sorts of applications. Also, it’s easier than forming or casing sausages, or piling meat on a spit you might not have.
