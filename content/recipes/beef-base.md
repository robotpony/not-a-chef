...
Using a pressure cooker results in a wetter end result. If you’re using the wetter beef for salad or tacos, you can brown it in a frying pan on medium/high, reducing the remaining liquid, turning it regularly. The result is much more savoury than the other methods, though with the frying step it takes about as long as using a standard pan.
