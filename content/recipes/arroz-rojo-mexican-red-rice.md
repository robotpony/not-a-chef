...
- The tomato blend is the flavour base. Don't skip the blend step, even if it seems like extra work.
- Toasting until genuinely golden (not just warm) is what keeps the rice from going mushy.
- Knorr chicken bouillon is key to the flavour; regular chicken stock is a poor substitute here.
