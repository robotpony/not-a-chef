...
Rough dice and roast peppers, carrots, onions, and garlic tossed in light oil (220C, 20-30 minutes).

Chop and fry mushrooms until golden brown. Add whole spices (if using). Add tomato paste and fry until paste starts to stick. Deglaze with wine, scraping up any brown bits in the pan.

Add stock and roasted veg, and cook until veg softens.

Blend thoroughly and (optionally) pour through a fine mesh strainer, using a ladle to help it through.

Add coconut cream solids, and season to taste. Reserve the remaining coconut milk for thinning the soup if needed.

The resulting soup should coat the back of a spoon.
