...
Germinating and watering are similar to the Biosta grower. Key is to hydrate the …
...
4. In a fine mesh strainer, rinse the seeds (some seeds may not need this, check the instructions on the seeds just in case).
    ...
    1. Alternatively, soak the seeds in the tray by watering (this is what I usually do).
