...
**Technique**
Cut mid-action so two shots share a kinetic arc. The motion completes across the edit, and the brain supplies the missing frames. Creates momentum without chaos. Requires pre-planned coverage and multiple takes of each gesture so you have a cut point at the right phase of motion.
...
- Shot B: CU of knife arriving at cutting board on downswing
- Audience brain stitches into one fluid motion
- Compression: 30 seconds of chopping into 2 cuts
...
**Food application**
Mise en place assembly: each cut lands on the next ingredient hitting the board, already partially chopped. Bread baking: each cut advances the Maillard browning by one stop: raw, pale, golden, amber, dark. Cumulative state change read instantly without narration.

**Concrete example**
- Cut 1: raw onion, whole
- Cut 2: onion halved
- Cut 3: onion sliced
- Cut 4: onion diced, knife at rest
- Total runtime: 6 seconds. Information density: very high.
...
**Food application**
Open on finished plated dish (smash). Then cut back: "here is what I almost destroyed." Non-linear recipe narration. It works especially well for long braises, ferments, or any recipe with catastrophic failure risk. Treats the recipe like a mystery, not a tutorial.

**Concrete example**
- Beat 1: Beautiful ramen in bowl
- Beat 2 (smash): Raw broth at 6am, narrator looking exhausted
- Narration: "It started here."
...
**Food application**
Chef turns sharply to the stove → whip pan → land on a time-lapse of the braise cooking over 4 hours. The turn is the trigger; the pan is the time jump. Works for any long passive wait that would otherwise require narration to skip.

**Concrete example**
Motivated by wrist flick when tossing pasta → whip → land in finished plated shot. Viewer feels the continuity of effort even though hours collapsed.
...
**Concrete example**
Still on hero shot of raw steak → faint sizzle fades in → cut to pan → sizzle at full volume. Viewer's brain is already in "cooking" mode before they see it.
...
**Food application**
Gentle tap of a spoon on a ramekin sounds like a cathedral bell. The "plop" of a single drop of sauce is a bass thud. Works best on moments of disappointment or unearned pride: small thing, big sound = funny.

**Concrete example**
Chef carefully plates a single microgreen. Sound effect: thunderclap. Back to chef looking satisfied. Cut.
...
**Food application**
Open every episode with a fast 8–10 shot montage of the kitchen: stove, fridge, knives, mise en place station. Each shot is 1.5 seconds, oriented. Now every later shot of someone reaching for something carries spatial weight: "that's the far side of the stove" means something.

**Concrete example**
Establish: left side = prep, right side = fire. A crossing shot, reaching from prep to fire, reads as escalation without a single word of narration.
...
**Technique**
Wright plants a visual or behavioural motif early, then returns to it later in a different context. The callback pays off for observant viewers and creates a feeling of structural coherence, as if the story planned itself.

**Food application**
Chef takes the onions darker than planned in the first 2 minutes. The exact same shot (dark pan, same angle) appears at minute 14 when the dish succeeds *because* of the deep caramelization. Same image, completely recontextualized. Works especially well for redemption arcs or unexpected techniques.

**Concrete example**
- Shot A (early): black-bottomed pan, chef winces
- Shot B (late): same angle, same pan, chef smiles; it's intentional this time
...
**Food application**
Chef tastes something. Expression of mild horror. Normal video cuts immediately. Wright-style: hold for 2–3 beats. Viewer extrapolates the horror. Works for unexpectedly good and unexpectedly bad outcomes equally.

**Concrete example**
Reaction shot begins at 1.5s. Normal editors cut at 2s. Wright cuts at 3.5s. That 1.5-second extension is the punchline.
...
**Technique**
Cut to an extreme close-up of something mundane with the same gravity as a plot-critical object. The humour comes from the mismatch between the shot's weight and its subject. Used throughout *Spaced*.

**Food application**
Cut to clinical ECU of a single caper. Hold. Cut back to chef who just said "and add the capers." The shot treats the caper as evidence in a crime scene. No narration, no music change. The gravity is the joke.

**Concrete example**
ECU of a fish sauce bottle with dramatic lighting. Two-second hold. Chef's hand enters, tips bottle, exits. Cut.
...
**Food application**
Cross-cut between chef carefully tempering chocolate and a second chef casually eating chocolate out of the bag. Same ingredient, entirely different relationship to it. Or: cross-cut between the stated "correct" technique and what's actually happening.

**Concrete example**
Narration: "gently fold until just combined." Cut to: aggressive, chaotic folding. Narration continues, oblivious.
...
**Technique**
Anderson's actors are positioned like exhibits, often facing the camera directly. Movement is deliberate and choreographed rather than naturalistic. The artificiality is the style. It signals that this is a performance, not a document. The humour comes from the precision of the staging, not from anything said.

**Food application**
Host faces camera directly. States one fact. Does not look at the food they're describing. Turns 90 degrees. Performs the action. Turns back. Useful for instructional moments where Wright's kinetic energy would be wrong, such as slow, deliberate technique or ratio-based information.
...
**Food application**
Freeze mid-fall of a collapsing soufflé, or a sauce skin forming. Text appears: "this is fine." Use sparingly: once or twice per video at most, or it becomes a crutch.

**Concrete example**
Soufflé rising perfectly → freeze → "4 minutes and 23 seconds of smugness" → resume → collapse.
...
**Food application**
Open on plating the dish. Then rewind: "to understand this, we need to start 24 hours ago." Braises, ferments, and multi-day cooks are naturals for this structure. The finished dish becomes a mystery to be solved, not a destination to reach.
...
4. Day 2 refinement
5. Day 3 final cook
6. Plate → match cut back to opening shot
...
**Food application**
A bread proof at 1000× feels like impatience. A gentle 60× proof feels like meditation. The speed of the time-lapse is an editorial statement about the emotional quality of the waiting. Most food video time-lapses are neutral; making them expressive costs nothing.

**Concrete example**
Aggressive quick-cut time-lapse of messy prep = chaos energy. Single slow near-real-time shot of steam rising from broth = calm confidence. Same waiting, different story.
...
**Technique**
The camera tracks left or right to reveal a pre-staged scene as if pulling back a curtain on a diorama. Used throughout *The Grand Budapest Hotel* and *The French Dispatch*. The track doesn't follow a character; it reveals a tableau the character is already part of.
